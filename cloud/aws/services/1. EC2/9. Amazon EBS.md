...
*   **Tính co giãn linh hoạt (Elasticity)**:
    ...
    *   ⚠️ **LƯU Ý QUAN TRỌNG**: Hệ thống **chỉ cho phép tăng dung lượng, không cho phép giảm dung lượng**. Nếu muốn giảm kích thước ổ đĩa, bạn bắt buộc phải tạo một volume mới nhỏ hơn rồi di chuyển dữ liệu sang.
