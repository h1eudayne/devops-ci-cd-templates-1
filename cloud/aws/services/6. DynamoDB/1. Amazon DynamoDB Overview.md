...
> **Amazon DynamoDB** là dịch vụ cơ sở dữ liệu **NoSQL** được quản lý hoàn toàn (Fully Managed) bởi AWS, cung cấp hiệu năng nhanh, nhất quán với khả năng mở rộng quy mô cực kỳ linh hoạt mà không làm gián đoạn hệ thống.
