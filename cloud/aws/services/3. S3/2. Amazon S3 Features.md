...
Các tính năng này được chia làm 4 nhóm chính:
1. **Storage Classes (Lớp lưu trữ)**: Tối ưu chi phí dựa trên tần suất truy cập.
2. **Storage Management (Quản lý lưu trữ)**: Kiểm soát vòng đời và sao chép dữ liệu.
...
### 1. S3 Lifecycle (Quản lý vòng đời)
...
### 2. S3 Object Lock (Khóa đối tượng)
...
### 3. S3 Replication (Sao chép dữ liệu)
...
### 4. S3 Batch Operations (Thao tác hàng loạt)
