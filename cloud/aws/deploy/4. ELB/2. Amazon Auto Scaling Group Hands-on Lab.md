...
3. **Kiểm tra tự động đăng ký Targets & Cân bằng tải**:
   ...
   * Mở trình duyệt và truy cập vào địa chỉ **DNS name của Load Balancer**, trang web hiển thị nội dung chào mừng từ các web server con mà bạn đã enable dịch vụ ở Bước 2.
