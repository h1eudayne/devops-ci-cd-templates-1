...
| [2. Amazon Auto Scaling Group Hands-on Lab](4.%20ELB/2.%20Amazon%20Auto%20Scaling%20Group%20Hands-on%20Lab.md) | Các bước thực hành chuẩn bị Base Image (Golden Image) từ EC2 gốc bằng cách kích hoạt dịch vụ httpd tự chạy cùng hệ thống và đóng gói thành AMI | AWS ASG, EC2, SSH, AMI, Systemd |
