...
sudo useradd dev01
```
*(⚠️ **Lưu ý**: Lệnh này tạo tài khoản người dùng `dev01` nhưng không thiết lập mật khẩu trực tiếp. Việc đăng nhập của tài khoản này sẽ phụ thuộc hoàn toàn vào khóa SSH ở các bước tiếp theo để tăng cường bảo mật).*
