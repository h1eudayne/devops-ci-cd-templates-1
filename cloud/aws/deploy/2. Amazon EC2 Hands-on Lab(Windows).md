...
4.  **Cấu hình ổ cứng (Storage - Lưu ý quan trọng)**:
    ...
    *   ⚠️ **Lưu ý**: Khác với Linux có thể hoạt động với 8 GiB, hệ điều hành Windows Server yêu cầu dung lượng ổ đĩa tối thiểu là **30 GiB** để có thể boot hệ thống và hoạt động bình thường. Không giảm dung lượng cấu hình này xuống dưới 30 GiB.
